...
//             View
//           </Button> */}
//           <Button className="btnDel" type="primary" danger ghost onClick={handleDelete(record)}>
//             Delete
//           </Button>
//         </div>
//       </Space>
...
const CommentTable = () => {
  ...
  const getComments = async () => {
    try {
      ...
      if (response.data.success) {
        setComments(response.data.review);
      }
  ...
  useEffect(() => {
    // Assuming you want to fetch comments when the component mounts
    getComments();
